...
def faiss_metadata_index_loader(metadata_path: str = 'explorer/indexes/metadata/schema.md', page_content_column: str = 'y'):
...
def pandas_df_vectorstore_loader(data_path: str = 'explorer/indexes/samples/telemetry_sample_forecast.csv', page_content_column: str = 'y'):
    df = pd.read_csv(data_path)
    ...
    vectorstore_ts = Chroma.from_documents(docs, embeddings, persist_directory="croma_index")
